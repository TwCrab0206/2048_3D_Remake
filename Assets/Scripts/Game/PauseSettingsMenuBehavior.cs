...
public class PauseSettingsMenuBehavior : MonoBehaviour
{
    [SerializeField] CinemachineInputAxisController _cmInputAxisController;
    ...
    public UnityEvent OnBindingChange;
    ...
    {
        _animator.SetBool("isMenuOn", false);
    }
    ...
    {
        _animator.SetBool("isMenuOn", true);
    ...
    {
        _resolutionsList = new (Screen.resolutions.ToList());
        _resolutionsList.Reverse();

        //Ignore duplicate resolutions just because of different refresh rates
    ...
    public void OnXAxisSensitiveChanged(float value)
    {
        ...
        _cmInputAxisController.Controllers[0].Input.Gain = value;
    }
    ...
    public void OnYAxisSensitiveChanged(float value)
    {
        ...
        _cmInputAxisController.Controllers[1].Input.Gain = -value;
    }
